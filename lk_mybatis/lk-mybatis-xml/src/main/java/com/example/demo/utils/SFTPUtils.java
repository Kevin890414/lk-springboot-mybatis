...
public class SFTPUtils {
    ...
    private static final String host = "192.168.30.37";
    private static final int port = 22;
    private static final String username = "iap";
    private static final String password = "iap";
    public static final String directory = "/home/iap/ftp/sec";
    ...
    public static void main(String[] args) throws IOException {
        ...
        sf.upload("/home/iap/ftp/sec", "E:\\file\\用户信息20190823.xls");    //上传文件
